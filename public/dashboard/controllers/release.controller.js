(function () {
  ...
  angular.module('app.basic')
    .controller('releaseDataCtrl', ['$scope', '$rootScope', '$state', '$stateParams', '$interval', 'releaseStatsService', function ($scope, $rootScope, $state, $stateParams, $interval, releaseStatsService) {
      ...
      $scope.latestReleaseData = function () {
        ...
        releaseStatsService.get({
          'release_name': $state.params.release_id
